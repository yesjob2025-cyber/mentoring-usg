...
// 최종 포스터 기준. 표기는 "분야 · 기업"만(멘토 이름 비공개, 프로필 연동용).
export const TALK_SCHEDULE: TalkDay[] = [
  { date: "2026-08-24", slots: [
    s("IT분야", "인공지능", "대웅제약", "신호선"),
    s("공학", "조선", "HD현대중공업", "정현천"),
    s("인문상경", "경영기획", "KPX케미칼", "김주경"),
    s("기타", "브랜딩 디자인", "삼진어묵", "육진태"),
    s("공공", "교통분야", "한국철도공사", "연상헌"),
  ] },
  { date: "2026-08-25", slots: [
    s("IT분야", "데이터분석", "삼성전자", "이원준"),
    s("공학", "반도체", "SK하이닉스", "김결"),
    s("인문상경", "경영회계", "코카콜라음료", "이유경"),
    s("기타", "승무원", "에어부산", "임하얀"),
    s("공공", "발전", "한국남동발전", "남태환"),
  ] },
  ...
  { date: "2026-08-27", slots: [
    ...
    s("공학", "방산", "LIG넥스원", "김도엽"),
    s("인문상경", "무역", "한화", "권혁진"),
    s("기타", "제품디자인", "현대자동차", "이유손"),
    s("공공", "소재연구", "한국재료연구원", "김재연"),
  ] },
  { date: "2026-08-28", slots: [
    s("IT분야", "SW개발", "한화에어로스페이스", "차은영"),
    s("공학", "제약바이오", "한국존슨앤드존슨", "박정환"),
    s("인문상경", "영업", "은산해운항공", "노경용"),
    s("기타", "방송", "스튜디오 유별히", "서혜인"),
    s("공공", "공단", "국민건강보험공단", "김보경"),
  ] },
  { date: "2026-08-31", slots: [
    s("인문상경", "금융", "기업은행", "추용호"),
    s("인문상경", "인사총무", "LS일렉트릭", "김수연"),
    s("기타", "MD", "무신사", "박예슬"),
    s("기타", "보건의료", "인제대백병원", "오선영"),
    s("공공", "교통", "부산교통공사", "배성림"),
  ] },
  { date: "2026-09-01", slots: [
    s("공학", "화학/철강", "포스코스틸리온", "설재욱"),
    s("인문상경", "물류관리", "CJ대한통운", "성주현"),
    s("기타", "엔터테인먼트", "카카오엔터테인먼트", "하성진"),
    s("기타", "서비스", "에버미라클호텔", "이하진"),
    s("공공", "공단", "중소벤처기업진흥공단", "이지현"),
  ] },
